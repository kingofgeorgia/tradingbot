...
+
+    def calculate_order_quantity(self, *, entry_price: float, total_equity: float, free_quote_balance: float, filters) -> float:
...
+        self.order_payload_by_id: dict[int, dict[str, object]] = {}
...
+            raise AssertionError("next_confirm_payload was not configured")
