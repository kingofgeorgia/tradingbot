...
cat > tests/test_state_store.py <<'PY'
from __future__ import annotations
...
cat > tests/test_order_manager.py <<'PY'
from __future__ import annotations
...
rm -f docs/architecture/test_order_manager.py
rm -f docs/architecture/test_state_store.py

echo "Applied test fixes."
